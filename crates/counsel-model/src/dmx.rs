//! DMX API model provider - OpenAI-compatible API
...
impl DmxProvider {
    pub fn new(model: impl Into<String>, api_key: impl Into<String>, user_id: impl Into<String>) -> Self {
        Self {
            name: "dmx".into(),
            ...
            base_url: "https://www.dmxapi.cn/v1".into(),
            model: model.into(),
...
impl ModelProvider for DmxProvider {
    fn name(&self) -> &str {
        &self.name
    }
