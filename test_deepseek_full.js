...
async function runTest() {
  console.log('================================================');
  console.log('Counsel App Full Flow Test with DeepSeek + Simulation');
  console.log('================================================');
  ...
  try {
    ...
    const projectRes = await fetch(`${API_BASE}/api/projects`, {
      ...
      body: JSON.stringify({ name: 'DeepSeek Full Simulation' })
    });
    ...
    console.log('\n================================================');
    console.log('DEEPSEEK TEST COMPLETED - PERFORMANCE SUMMARY');
    console.log('================================================');
