...
# Local-dev convenience: mirror tempdir-mode session/user files to ./sessions/
# on disk so you can inspect them. PRODUCTION DEPLOY: do not set this — it
# defeats the stateless-server property. Set COUNSEL_DEV_MIRROR=0 to disable.
export COUNSEL_DEV_MIRROR=${COUNSEL_DEV_MIRROR:-1}
